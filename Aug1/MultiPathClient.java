...
public class MultiPathClient extends JFrame
{
   ...
   public void workWithSwitch( int value )
   {
    ...
    //
      ...
      switch(value) {
         case 0 :  System.out.println("0 was input");
                   animate (0, value);
                   break;
         case 1 :  System.out.println("1 was input");
                   animate (1, value);
                   break;                  
         case 2 :  System.out.println("2 was input");
                   animate (2, value);
                   break;
         case 3 :  System.out.println("3 was input");
                   animate (3, value);
                   break;
         case 4 :  System.out.println("4 was input");
                   animate (4, value);
                   break;
         default : System.out.println("Invalid input value...you broke it.");
                   animate (-1, value);
      }
